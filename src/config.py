...
image_dir =  os.path.join(curPath, 'image')
template_dir = os.path.join(curPath, 'templates')
background_dir = os.path.join(curPath, "background")
static_dir = os.path.join(curPath, "static")
run_dir = os.path.join(curPath, "run")
html_dir = os.path.join(curPath,"html")
save_dir = os.path.join(curPath, "save")
model_dir = os.path.join(curPath,'model')
...
# New Word Discovery
# save user input data
new_word_discovery_file_save_path = os.path.join(save_dir, 'new_word_discovery_input_file.txt')
# download new words result
download_new_word_output_file_save_path = os.path.join(save_dir, 'new_word_discovery_output.txt')
